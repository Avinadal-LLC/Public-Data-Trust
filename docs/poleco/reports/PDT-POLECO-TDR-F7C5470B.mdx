...
tags: [poleco, reports]
---
# PDT-POLECO-TDR-F7C5470B

# Trade Data Report
**Subject:** Point-in-Time Trade Data Summary for Major Hadieia Galactic Factions  
**Prepared by:** Hadieia Galactic Trade Commission [Data], Public Data Trust [Analysis]

---

## Executive Summary

The first half of year has seen robust, if uneven, economic activity across the Hadieia Galaxy. The Hadieia Galactic Federation (HGF) continues to dominate both industrial output and interstellar trade volume, while the Cybercratic Union of Waerrani People (CUWP) exhibits steady growth through sustainable development and technology exports. The Plasidian Royal Union (PRU), newly unified under Empress Enyxia, is emerging as a niche supplier of rare resources, despite technological lag.
...
* **Notable Transactions:**
    * 150,000 units of “organic resources” shipped to undisclosed research facilities (destination and nature of cargo obfuscated per security protocols).
    * 80,000 units of terraformation stabilizers imported from CUWP.
* **Capital System:**
    * **Name:** Eneshia
...
* **Notable Transactions:**
    * 45,000 units of “integrated environmental control arrays” exported to EoA (description per ITC guidelines).
    * 12,000 units of “structural ore” imported from EoA for infrastructure development.
* **Core System:**
    * **Name:** Waerr
...
* **Notable Transactions:**
    * 8,000 units of “CM Crystals” exported to EoA (transaction value: ₲2.4 million).
    * 1,200 units of “nondescript construction equipment” imported from EoA.
* **Core System:**
    * **Name:** Plasid
...
* **Notable Transactions:**
    * 22,000 units of “multi-purpose fauna” exported to CUWP.
    * 4,000 units of “ore concentrate” imported from EoA.
* **Core System:**
    * **Name:** Kishi
...
* **Notable Transactions:**
    * 6,000 units of “structural ore” exported to CUWP.
    * 1,500 units of “livestock fauna” imported from RoK.
* **Core System:**
    * **Name:** Ekrien
